	...
	Crafty.scene("game", function() {
		...
		$.getJSON("data/room1.json", function(json) {
			...
			.createWorld( function( map ) {
					...
					//Obstacles
					for (var obstacle = 0; obstacle < map.getEntitiesInLayer('Tiles 2').length; obstacle++){
						map.getEntitiesInLayer('Tiles 2')[obstacle]
		...
		// create character
		Crafty.e("2D, DOM, Collision, Grid, player, CharAnims, Multiway, MouseFace")
		.attr({
